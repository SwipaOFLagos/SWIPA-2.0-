     ...
     <div className='right-icons'>
      ...
      <Offcanvas show={show} onHide={handleClose}>
         <div className='show-header'>
          ...
          <Offcanvas.Header closeButton className='off-header'></Offcanvas.Header>
        ...
        <Offcanvas.Body className='off-main'>
          ...
          <ul className='last-li'>
           <a href='/crew' style={{textDecoration:"none", color: "white",}}>
               <li>My Account</li>
           </a>

           <a href='/technology' style={{textDecoration:"none", color: "white"}}>
               <li>Help</li>
           </a>
